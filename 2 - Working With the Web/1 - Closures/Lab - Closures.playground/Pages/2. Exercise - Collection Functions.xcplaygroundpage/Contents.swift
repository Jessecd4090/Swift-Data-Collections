...
let family = ["Heather", "Jestin", "Emma", "Cody", "Jesse", "Caleb"]
let sortedCollection1 = family.sorted(by: forwards(name1:name2:))
...
let sortedCollection2 = family.sorted { name1, name2 in
    return name1 < name2
}
...
let sortedCollection3 = family.sorted { return $0 < $1 }
